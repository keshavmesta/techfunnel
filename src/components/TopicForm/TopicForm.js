...
import topicValidation, {colors} from './topicValidation';
...
@connect(
  ...
  dispatch => bindActionCreators(topicActions, dispatch)
)
@reduxForm({
  form: 'topic',
  fields: ['id', 'color', 'sprocketCount', 'owner'],
  validate: topicValidation
})
export default class TopicForm extends Component {
  ...
  render() {
    ...
    const styles = require('containers/Topics/Topics.scss');
    return (
