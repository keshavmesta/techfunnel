      ...
      <div className={styles.home}>
        ...
        <div className={styles.masthead}>
          <div className="container">
            ...
            <p>
              <a className={styles.github} href="https://github.com/keshavmesta/techfunnel"
                 target="_blank">
                <i className="fa fa-github"/> View on Github
              </a>
            </p>
            <GithubButton user="keshavmesta"
                          repo="techfunnel"
                          type="star"
                          width={160}
                          height={30}
        ...
        <div className="container">
          ...
          <dl>
            ...
            <dd>
              The <Link to="/topics">Topics page</Link> demonstrates how to fetch data asynchronously from
              some source that is needed to complete the server-side rendering. <code>Topics.js</code>'s
              <code>fetchData()</code> function is called before the topics page is loaded, on either the server
              or the client, allowing all the topic data to be loaded and ready for the page to render.
            </dd>
            <dt>Data loading errors</dt>
            <dd>
              The <Link to="/topics">Topics page</Link> also demonstrates how to deal with data loading
              errors in Redux. The API endpoint that delivers the topic data intentionally fails 33% of
              the time to highlight this. The <code>clientMiddleware</code> sends an error action which
              the <code>topics</code> reducer picks up and saves to the Redux state for presenting to the user.
            </dd>
            ...
            <dt>Forms</dt>
            <dd>
              The <Link to="/post">Post page</Link> uses the
